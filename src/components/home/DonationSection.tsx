	...
	return (
		<section className="py-20 bg-gradient-hero relative overflow-hidden">
			...
			<div className="container mx-auto px-4 relative z-10">
				...
				<div className="grid lg:grid-cols-2 gap-12 max-md:gap-2 items-start">
					{/* Content */}
					<div className="">
						<div>
							...
							<p className="text-primary-foreground/80 leading-relaxed mb-8">
								...
								is like a seed of grain that grows seven ears; in every ear
								there are a hundred grains. Allah multiplies for whom He wills."
					...
					<div className="">
						<h2 className="text-gold font-serif text-3xl md:text-4xl font-bold text-primary-foreground/ mb-6">
							Donate Now
						</h2>
						<img
							src={qrCode}
							alt="qr-code"
							className="mx-auto/ ml-10 w-36 object-contain"
						/>
					</div>
