...
import { Heart, Building, BookOpen, Users, Utensils, GraduationCap, Repeat, CreditCard, Banknote, Landmark } from "lucide-react";

const donationCategories = [
  {
    icon: Building,
    title: "Masjid Maintenance",
    description: "Help maintain our beautiful masjid and keep it a welcoming space for worship.",
    amount: "$15,000",
    goal: "$25,000",
    color: "bg-primary",
  },
  {
    ...
    description: "Support Quran classes, Islamic studies, and youth education programs.",
    amount: "$8,500",
    goal: "$15,000",
    color: "bg-gold",
  },
    ...
    <Layout>
      ...
      <section className="relative py-20 bg-gradient-hero overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary-foreground/10 backdrop-blur-sm border border-primary-foreground/20 mb-6">
            ...
            <span className="text-sm text-primary-foreground/90">Support Our Masjid</span>
          </div>
          <h1 className="font-serif text-4xl md:text-5xl font-bold text-primary-foreground mb-6">
            Your Generosity Makes a Difference
          </h1>
          <p className="text-xl text-primary-foreground/80 max-w-2xl mx-auto mb-8">
            "The example of those who spend their wealth in the way of Allah is like a seed of grain that grows seven ears; in every ear there are a hundred grains."
          </p>
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto bg-secondary rounded-2xl p-8 shadow-elevated">
            <h2 className="font-serif text-2xl font-bold text-center mb-8">Quick Donation</h2>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12">
            <div className="bg-primary/5 rounded-2xl p-8 border border-primary/20">
              <h3 className="font-serif text-2xl font-bold text-foreground mb-4">Zakat</h3>
              <p className="text-muted-foreground mb-4">
                Zakat is one of the Five Pillars of Islam and is obligatory for those who meet the nisab threshold. It purifies your wealth and supports those in need.
              </p>
            ...
            <div className="bg-gold/5 rounded-2xl p-8 border border-gold/20">
              <h3 className="font-serif text-2xl font-bold text-foreground mb-4">Sadaqah</h3>
              <p className="text-muted-foreground mb-4">
                Sadaqah is voluntary charity given out of compassion, love, or generosity. It can be given at any time and in any amount.
              </p>
              <ul className="space-y-2 text-sm text-muted-foreground mb-6">
                <li className="flex items-center gap-2">
      ...
      <section className="py-16 bg-secondary">
        <div className="container mx-auto px-4 text-center">
          <h2 className="font-serif text-2xl font-bold text-foreground mb-8">Other Ways to Give</h2>
